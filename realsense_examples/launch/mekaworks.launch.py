...
def generate_launch_description():
    ...
    front_camera = Node(
        ...
        respawn=False,
        parameters=[
            os.path.join(get_package_share_directory('realsense_examples'),'config','mekaworks.yaml'),
            {
            'json_file_path': full_json_file_path, 
            }],
        remappings=[('/front/camera/imu/sample', '/imu/data_raw')]
        )
    ...
    return launch.LaunchDescription([front_camera, back_camera])
